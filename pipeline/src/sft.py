...
if __name__ == "__main__":
    ...
    if args.model == "Qwen":
        ...
        tokenizer = AutoTokenizer.from_pretrained('codellama/CodeLlama-7b-Instruct-hf', padding_side="left", use_fast=False)
        tokenizer.pad_token = tokenizer.eos_token
        model = AutoModelForCausalLM.from_pretrained('codellama/CodeLlama-7b-Instruct-hf',
                                                     trust_remote_code=True, torch_dtype=torch.bfloat16,
                                                     device_map='auto')
        output_dir = "/home/pdia/data/GreenCoder/saved_models/CodeLlama-7b-SFT"
        ...
        output_dir = "/home/pdia/data/GreenCoder/saved_models/Qwen-7B-SFT"
        response_template = "<|im_start|>assistant"
    elif args.model == "Qwen3-8B-Base":
        model = AutoModelForCausalLM.from_pretrained("Qwen/Qwen3-8B-Base", 
                                                    #  attn_implementation="flash_attention_2",
                                                     torch_dtype=torch.bfloat16, device_map="auto")
        tokenizer = AutoTokenizer.from_pretrained("Qwen/Qwen3-8B-Base", padding_side="left")
        output_dir = "/home/pdia/data/GreenCoder/saved_models/Qwen3-8B-Base-SFT"
        response_template = "<|im_start|>assistant"
        ...
        output_dir = "/home/pdia/data/GreenCoder/saved_models/Qwen-7B-SFT-Round2"
        response_template = "<|im_start|>assistant"
        ...
        output_dir = "/home/pdia/data/GreenCoder/saved_models/DeepSeek-7B-SFT"
        response_template = "<|begin▁of▁sentence|>assistant"


        
    dataset = load_from_disk("/home/pdia/data/GreenCoder/datasets/sft_solidity_data")

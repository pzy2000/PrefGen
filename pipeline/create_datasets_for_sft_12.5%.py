...
def get_solidity_distilled_data(data_path):
    ...
    output_file = f"{data_path}/distilled_solidity_data_12.5%.json"
...
def process(num_proc: int, data_path: str, post_training_type: str):
    ...
    dataset = load_dataset('json', data_files=f"{data_path}/distilled_solidity_data_12.5%.json")["train"]
...
if __name__ == "__main__":
    ...
    for post_training_type in ["sft"]:        
        cache_dir = f"./datasets/{post_training_type}_solidity_data_12.5%"

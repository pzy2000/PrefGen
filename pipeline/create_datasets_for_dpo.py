...
def get_solidity_distilled_data(data_path):
    ...
    output_file = f"{data_path}/distilled_solidity_data_dpo.json"
...
def process(num_proc: int, data_path: str, post_training_type: str):
    dataset = load_dataset('json', data_files=f"{data_path}/distilled_solidity_data_dpo.json")["train"]
